...
function EditDraftThree(props) {
    ...
    const [onApproveMsg, setOnApproveMsg] = useState("")
    const [onApproveN, setOnApproveN] = useState(false);
    const [onApproveMsgN, setOnApproveMsgN] = useState("")
    ...
    const onApproveClick = () => {
        ApproveDraft().then((res) => {
            if (res.status) {
                // alert(res.message)
                setOnApprove(true);
                setOnApproveMsg(res.message);
            } else {
                setOnApproveN(true);
                setOnApproveMsgN(res.message);
                // alert(res.message)
            }
        })
    }
                ...
                >
                    ...
                    >
                        ...
                        <div className="col-3 mt-2">
                            {DataForTest && DataForTest.is_approved == 1 ? (
                                <button disabled className="btn cuss_btn">
                                    Approved
                                </button>
                            ) : (
                                <button
            ...
            {loader ? (
                ...
                <div style={{ marginTop: "8%", marginBottom: "5%" }}>
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="row">
                                <div className="col-12 box_shadow">
                                    <div>
                                        <div>
                                            <span style={{ fontWeight: 800, fontSize: 16, paddingRight: 8 }}> Product Name:</span>
                                            <span>{DataForTest && DataForTest?.first_product_name}</span>
                                        </div>
                                        <div>
                                            <span style={{ fontWeight: 800, fontSize: 16, paddingRight: 8 }}> Industry:</span>
                                            <span>{DataForTest && DataForTest?.industry}</span>

                                            {/* <span>{DataForTest && DataForTest?.industry[0]}</span> */}
                                            {/* {
                                                DataForTest && DataForTest?.industry.map((res) => (
                                                    <span>{res}  </span>
                                                ))
                                            } */}
                                        </div>
                                        <div >
                                            <span style={{ fontWeight: 800, fontSize: 16, paddingRight: 8 }}> Line of Business:</span>
                                            {
                                                DataForTest && DataForTest?.line_of_business.map((res) => (
                                                    <span>{res}  </span>
                                                ))
                                            }
                                        </div>
